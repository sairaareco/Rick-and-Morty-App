import style from "./css/FavCard.module.css";
import { Link } from "react-router-dom";
import { connect } from "react-redux";
import { useState, useEffect } from "react";
import {  addFavorite, deleteFavorite } from "../redux/actions";

const FavoriteCard = ({apiId, id, name, species, gender, image, onClose, myFavorites, addFavorite, deleteFavorite}) => {
...
return ( 
    ...
    <img src={image} 
        alt="imagen de un personaje de rick and morty" 
